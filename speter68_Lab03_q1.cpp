...
int main()
{
	...
	cout<<"******************************************************************************"<<endl;
	cout<<"     ES1036: Lab 03 Q1"<<endl<<"     Name: Stefan Peters"<<endl
	...
	int score(0), guess(0), last_attempt(0), counter(0);
	string answer, name, play_again;
	...
	cin>>answer;
	if(answer=="c"||answer=="C"||answer=="37")
	{
		cout<<"		Correct!\n\n";
		score = score++;
	}
	else cout<<"		Nope! The correct answer is 37.\n\n";
	//tenth question
	...
	if(counter>0)
	{
		if(last_attempt<score)cout<<" You did better than your previous attempt!\n\n";
		else cout<<"  You did not beat your previous score. Sorry.\n\n";
		cout<<"  Your score on your last attempt was "<<last_attempt<<".\n\n";
	}
	last_attempt=score;
	counter++;
